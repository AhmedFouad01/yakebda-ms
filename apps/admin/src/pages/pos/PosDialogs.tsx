    ...
    <>
      {historyOrder && (
        <div className="modal-back" onClick={() => setHistoryOrder(null)}>
          <div className="modal od-modal" role="dialog" aria-modal="true" aria-labelledby="pos-order-detail-title" onClick={(event) => event.stopPropagation()}>
      ...
      {adminPanel === "shift" && (
        <div className="modal-back" onClick={() => setAdminPanel(null)}>
          <div className="modal posx-admin-modal" onClick={(event) => event.stopPropagation()}>
            <ShiftPanel />
          </div>
        </div>
      )}
