...
export const ar = {
  ...
  errors: {
    ...
    kitchen_paused: "المطبخ متوقف مؤقتًا في هذا الفرع — لا يمكن إرسال طلبات جديدة الآن.",
    kitchen_already_paused: "المطبخ متوقف بالفعل في هذا الفرع.",
    kitchen_not_paused: "المطبخ يعمل بالفعل في هذا الفرع.",
    order_on_hold: "الطلب معلّق حاليًا — استأنفه أولًا قبل نقله إلى جاهز.",
    order_already_held: "الطلب معلّق بالفعل.",
    order_not_held: "الطلب غير معلّق.",
    order_hold_invalid_state: "لا يمكن تعليق الطلب إلا وهو في المطبخ.",
