...
export const REPORT_CATALOG: ReportDefinition[] = [
  ...
  },
  {
    ...
    description_ar: "إجمالي وعدد عمليات الدفع المحصلة؛ unpaid ليست وسيلة تحصيل ولا تدخل التقرير.",
    required_permissions: ["reports.view"],
    filters: [{ ...DAYS_FILTER }, { ...BRANCH_FILTER }],
  ...
  },
  {
    ...
    description_ar: "الأصناف الأعلى كمية وإجمالي قيمة بنود الطلبات غير الملغاة؛ القيمة Gross وليست صافي تحصيل.",
    required_permissions: ["reports.view"],
    filters: [{ ...DAYS_FILTER }, { ...BRANCH_FILTER }],
